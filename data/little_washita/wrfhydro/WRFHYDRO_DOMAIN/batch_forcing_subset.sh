#!/bin/bash
# Arugument: year to process (currently 2007-current). 
# Example (most common use): 
# qsub batch_forcing_subset.sh
# Example with passed arguments:
# qsub -v "year=2007",'west_east="west_east,3918,3929"','south_north="south_north,2380,2396"',out_path="/glade/scratch/arezoo/NWM_V21_CALIB_FORCING" batch_forcing_subset.sh
# Hardwired options below PBS directives (which you also need to edit).
#==========================================================================
...
# Set these variables if not using config file:
#site_no="10128500"
#west_east="west_east,1145,1175"
#south_north="south_north,2093,2111"
#in_path=/glade/p/cisl/nwc/nwm_forcings/AORC/
#out_path=/glade/scratch/adugger/CBRFC_priority_basins/Forcings_AORC/10128500/
#year_start=2007
#year_end=2018

# Instead of setting individually, source a config file generated by the subsetting tool:
source batch_forcing_subset_config.txt
